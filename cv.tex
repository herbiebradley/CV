...
\section{Skills}
\begin{tabular}{rl}
  \textsc{Knowledge of:} & Python, Machine Learning (Tensorflow, PyTorch, Keras), C++, Git, \\
  & Java (Android Development), Linux, \textsc{MATLAB},
...
\section{Awards}
\begin{tabular}{rl}
  2019 - 2020 & Warwick Taught Masters Scholarship - Full Tuition Fee Waiver \\
\end{tabular}
\bigskip
