...
\begin{tabular}{rl}
  ...
  & UnixLinux, Git, Android Studio, {\fb \LaTeX}\setmainfont[SmallCapsFont=Fontin-SmallCaps.otf]{Fontin.otf} \\
...
\section{Presentations}
\begin{tabular}{rl}
  \textsc{March} 2019 & \textit{Style Transfer with Deep Learning} - Keele Machine Learning Reading Group \\
...
\section{Awards}
\begin{tabular}{rl}
  \textsc{March} 2019 & Keele Social Squad Competition - Blog Post \\
\end{tabular}
\bigskip
